<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BCLoiNhuan_ChiTiet.aspx.cs" Inherits="BanHang.BCLoiNhuan_ChiTiet" %>
...
<body>
    ...
    <div>
        ...
        <dx:ASPxDocumentViewer ID="viewerReport" runat="server">
